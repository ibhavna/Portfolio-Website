...
st.write("**Python Based Personal Portfolio Website**- [Link]('https://github.com/ibhavna/Personal-Assistant)")
st.markdown('''
...
st.write("**AI Based Virtual Assistant with GUI** -  [Link]('https://github.com/ibhavna/Personal-Assistant)")
st.markdown('''
...
st.write("**Automated Stock Order Placing Application with Telegram Bot** - [Link]('https://github.com/ibhavna/Automated-Stock-Order-Placing-Application)")
st.markdown('''
